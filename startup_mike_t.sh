...
<head>
    ...
    <title>Michael E. Taylor II | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://thumbs.dreamstime.com/b/digital-clouds-glowing-circuits-dark-background-concept-cloud-computing-technology-341292535.jpg');
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <!-- HEADER WITH NAME -->
            <header>
                <h1>Michael E. Taylor II</h1>
                <p>Urban Renaissance Man | Entrepreneur | Lifelong Learner</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>Enthuse by Art, Music, & Life in General. Studying hard to become a Cloud Engineer. Take a peek...
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://static.wikitide.net/greatcharacterswiki/d/df/Cyborg_2003.png" alt="Photon Particle Physics Concept">
                <p>A balance between Light and the Dark</p>
            </div>
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>For more information please reach out michaeltaylor1107@gmail.com</p>
            </section>

            <!-- FOOTER -->
            <footer>
                <p>&copy; I’m here so I don’t get fined...</p>
            </footer>
